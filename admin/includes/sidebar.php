<?php
// Additional protection for the Sidebar using your existing session
...
<header class="main-header">
    ...
    <div class="header-profile">
        ...
        <div class="user-info">
            <span>Welcome, <strong><?php echo htmlspecialchars($_SESSION['user_name'] ?? 'Admin'); ?></strong></span>
